...
const BlogDetail = () => {
    ...
    useEffect(() => {
        async function getSiteBlogs() {
            try {
                const siteBlogApi = await axios.get(`https://y2hhbibraxroyw4.emiratesevisaonline.com/blog/${id}`)
                        ...
                        <div className="col-md-12">
                            <div className="all_content_blog">
                                <div className="cmt-post-featured">
                                    <img className="img-fluid" src={`data:image/png;base64,${siteBlogs.image}`} alt="bloginfo" loading="lazy"/>
