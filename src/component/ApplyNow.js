        ...
        var payloadData = (
            {
                "application": {
                    ...
                    "purposeOfVisit": {
                        "id": formData.purposeOfVisit
                    },
                    "siteInfo": {
                        "id": 2
                    },
                    "arrivalDate": formData.arrivalDateYear + "-" + formData.arrivalDateMonth + "-" + formData.arrivalDateDay,
                    "status": "DRAFT"
                },
                "residenceCountry": {
                    "id": formData.residenceCountry
                },
                ...
                "passportExpiryDate": formData.passportExpiryDateYear + "-" + formData.passportExpiryDateMonth + "-" + formData.passportExpiryDateDay,
                "isPrimary": true,
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <div className="date_gap">
                                                            <select
                                                                ...
                                                                onChange={e => onTextFieldChange(e)}
                                                                value={formData.passportExpiryDateDay}
                                                            >
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={e => onTextFieldChange(e)}
                                                                value={formData.passportExpiryDateMonth}
                                                            >
                                                            ...
                                                            <select
                                                                ...
                                                                onChange={e => onTextFieldChange(e)}
                                                                value={formData.passportExpiryDateYear}
                                                            >
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <div className="date_gap">
                                                            ...
                                                            <select
                                                                ...
                                                                id='arrivalDateMonth'
                                                                onChange={e => onTextFieldChange(e)}
                                                                value={formData.arrivalDateMonth}
                                                            >
                                                            ...
                                                            <select
                                                                ...
                                                                id='arrivalDateYear'
                                                                onChange={e => onTextFieldChange(e)}
                                                                value={formData.arrivalDateYear}
                                                            >
                                                                <option value="">Year</option>
                                                                {years.map((year, index) => (
                                                                    <option key={index} value={year}>{year}</option>
